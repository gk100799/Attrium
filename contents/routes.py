...
def csvUpload():
    ...
    if form.validate_on_submit():
        ...
        os.chdir('C:\\Users\\SKrishna\\Desktop\\College work\\Final \Year Project\\8th Sem\\Atrium\\User Uploads')
        f.save(os.path.abspath(filename))

        files = glob('C:\\Users\\SKrishna\\Desktop\\College work\\Final \Year Project\\8th Sem\\Atrium\\User Uploads\\*') 
